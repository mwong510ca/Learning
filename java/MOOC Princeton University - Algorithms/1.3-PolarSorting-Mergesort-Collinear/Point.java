...
public class Point implements Comparable<Point> {
    // compare points by slope -- YOUR DEFINITION HERE
     ...
     * / (x1 - x0). For completeness, the slope is defined to be +0.0 if the line
    ...
    public static void main(String[] args) {
        Point p = new Point(100, 456);
        System.out.println(p);
        Scanner scanner = extracted(p).useDelimiter("[^0-9]+");
    ...
    private static Scanner extracted(Point p) {
        return new Scanner(p.toString());
    }
}
