 ...
 *
 *  A generic data type for a deque implement elementary data structures using linked lists, 
 *  generic and iterators.
 *  Deque - A double-ended queue or dequeue is a generalization of a stack 
...
public class Deque<Item> implements Iterable<Item> {
     ...
     * 
     * @param args main function standard input
     */
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Enter 0 - exit, 1 - addFirst, 2 - addLast, 3 - removeFirst, 4 - removeLast:");
